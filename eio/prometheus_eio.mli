...
(** [callback] is a cohttp-eio request handler that serves [registry] at
    [/metrics] in the text format and answers anything else with
    [400 Bad Request]. Build and run a server with
    {[
    ...
    @param registry The registry to collect from, defaulting to
      {!Prometheus.CollectorRegistry.default}. *)
